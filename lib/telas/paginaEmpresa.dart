...
class PaginaEmpresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Platform.isIOS
        ? Scaffold(body: ScopedModelDescendant<CartModel>(
                        ...
                        OutlineButton(
                          ...
                          onPressed: () async {
                            ...
                            double distanceInMeters = await Geolocator()
                                .distanceBetween(latitude, longitude, laEmpresa,
                                    longEmpresa);

                            print(distanceInMeters);
                            double distancia = distanceInMeters / 1000;
                            double valorCorrida =
                                (distancia + 1.5) * 2.50 + 2.50;
                  ...
                  children: <Widget>[
                    Container(
                        decoration: new BoxDecoration(
                          image: new DecorationImage(
                            image:
                                new AssetImage("assets/fundo_pg_empresa.png"),
                            fit: BoxFit.cover,
                          ),
                        ),
                        child: null /* add child content content here */
                        ...
                        children: <Widget>[
                          ...
                          OutlineButton(
                            ...
                            onPressed: () async {
                              ...
                              double longEmpresa = longitudeEmpresa;
                              double distanceInMeters = await Geolocator()
                                  .distanceBetween(latitude, longitude,
                                      laEmpresa, longEmpresa);

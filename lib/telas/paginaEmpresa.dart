...
class PaginaEmpresa extends StatefulWidget {
  ...
  String nomeEmpresa, imagemEmpresa, descricaoEmpresa;
  UserModel user;
  List galeriaPagina;
  PaginaEmpresa(this.nomeEmpresa, this.imagemEmpresa, this.descricaoEmpresa,
      this.galeriaPagina);
  @override
  _PaginaEmpresaState createState() => _PaginaEmpresaState(
      nomeEmpresa, imagemEmpresa, descricaoEmpresa, galeriaPagina);
}
...
class _PaginaEmpresaState extends State<PaginaEmpresa> {
  ...
  UserModel user;
  _PaginaEmpresaState(@required this.nomeEmpresa, @required this.imagemEmpresa,
      @required this.descricaoEmpresa, this.galeriaPagina);
                      ...
                      InkWell(
                        ...
                        child: Container(
                          child: ClipRRect(
                            ...
                            child: Image.network(galeriaPagina.elementAt(1)),
                          ),
                        ),
                      ),

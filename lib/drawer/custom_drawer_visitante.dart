...
class CustomDrawerVisitante extends StatefulWidget {
  String uid;

  CustomDrawerVisitante(this.uid);

  @override
  _CustomDrawerVisitanteState createState() => _CustomDrawerVisitanteState(uid);
}

class _CustomDrawerVisitanteState extends State<CustomDrawerVisitante> {
  UserModel user;
  String uid;
  String photo;
  _CustomDrawerVisitanteState(this.uid);
